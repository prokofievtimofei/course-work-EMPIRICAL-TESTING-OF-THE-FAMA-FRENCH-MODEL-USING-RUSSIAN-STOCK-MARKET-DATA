...
run_grs_full("Full sample (Jul 2016 – Feb 2026)", as.Date("2016-07-01"), as.Date("2026-03-01"), n_ports = 22)


# ================================================================
# 11a. GRS TEST — SUBPERIODS (N=22, excluding chronically empty portfolios)
# ================================================================
